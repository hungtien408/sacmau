    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["pi"]))
            {
                ...
                {
                    lblContent.Text =
                        "Giấy dán tường Montana/…/….Có nhiều màu sắc, hoa văn để Quý khách dể lựa chọn cho phù hợp với căn phòng của mình cũng như cho con em mình.<br/><br/>Quy cách: 106cm x 15.6m = 16.5m2<br/><br/><p style='font-styles:italic; font-weight:bold; text-decoration: underline;'>Đặc tính:</p>- Bề mặt phủ clemastic.<br/>- Có khả năng chịu kiềm, axit.<br/>- Không phai màu, bạc màu.<br/>- Khó bám bẩn, chống rêu mốc.<br/>- Dể thi công, không bụi bẩn khi dán.<br/>- Dán được trên mọi bề mặt dể dàng với độ bám dính cao.<br/>- Thân thiện với môi trường, không chất độc hại.<br/><p style='font-styles:italic; font-weight:bold; text-decoration: underline;'>Chế độ bảo hành:</p>- Bảo hành lỗi kỹ thuật thi công, lỗi sản phẩm.<br/>- Không bảo hành do tường ẩm, trầy tróc, vật cứng tác động.";
                }

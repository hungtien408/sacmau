                    ...
                    <div class="desription">
                        <ul class="list-info">
                            ...
                            <li><strong>Giá bán:</strong> <del>
                                ...
                                <strong>
                                    <%# string.IsNullOrEmpty(Eval("OtherPrice").ToString()) ?(string.Format("{0:##,###.##}", Eval("Price")).Replace('.', '*').Replace(',', '.').Replace('*', ',')) :  Eval("OtherPrice") %><%# string.IsNullOrEmpty(Eval("Price").ToString()) ? "<span style='color: #f00; font-weight: 300; font-size: 16px; font-style: italic;'>Liên hệ</span>" : "đ"%></strong></li>
                        </ul>

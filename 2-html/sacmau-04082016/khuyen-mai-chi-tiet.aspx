<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="khuyen-mai-chi-tiet.aspx.cs" Inherits="gioi_thieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <h4 class="title-2">khuyến mãi</h4>
        <div class="wrapper-text about-us">
            ...
            <div style="text-align: center; margin-bottom: 10px;"><img src="assets/images/about-img.jpg" alt=""/></div>
